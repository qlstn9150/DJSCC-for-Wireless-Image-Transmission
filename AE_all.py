...
for comp_ratio in compression_ratios:
    ...
    print('---> System Will Train, Compression Ratio:'+str(comp_ratio)+', SNR:'+str(snr)+' <---')
    #_ = CNN_AE(x_train, x_test, nb_epoch=750, comp_ratio=comp_ratio, batch_size=16, c=c, snr=snr, saver_step=50)
    _ = DenseNet_AE(x_train, x_test, nb_epoch=10, comp_ratio=comp_ratio, batch_size=4, c=c, snr=snr, saver_step=5)
