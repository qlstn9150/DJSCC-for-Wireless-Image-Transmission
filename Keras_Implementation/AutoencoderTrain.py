...
from AutoencoderModel import CNN_AE,DenseNet_AE, Calculate_filters
...
for comp_ratio in compression_ratios:
    ...
    #_ = CNN_AE(x_train, x_test, nb_epoch=6, comp_ratio=comp_ratio, batch_size=4, c=c, snr=0, saver_step=2)
    _ = DenseNet_AE(x_train, x_test, nb_epoch=4, comp_ratio=comp_ratio, batch_size=4, c=c, snr=snr, saver_step=2)